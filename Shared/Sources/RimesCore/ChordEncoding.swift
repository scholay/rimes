// Derived from RIMES ChordOutputEncoding.swift (MIT); encoding parity tested.
import Foundation
...
/// pinyin.
public enum ChordOutputEncoding: String, Codable, CaseIterable, Equatable, Hashable {
    case fullPinyin
...
public enum ZiranmaShuangpin {
    /// Emitted verbatim as `speller/algebra` of generated 自然码 chord schemas.
    public static let syllableAlgebra: [String] = [
        "erase/^xx$/",
        "derive/^([jqxy])u$/$1v/",
    ...
    public static let preeditFormat: [String] = [
        "xform/(^|[ '])aa/$1a/",
        "xform/(^|[ '])ee/$1e/",
        "xform/(^|[ '])oo/$1o/",
    ...
    public static let initials = ["zh", "ch", "sh", "b", "p", "m", "f", "d", "t", "n", "l",
    ...
    public static func syllableCode(_ pinyin: String) -> String? {
    ...
    public static func fragmentCode(_ pinyin: String) -> String? {
        switch pinyin {
        case "zh": return "v"
        case "ch": return "i"
        case "sh": return "u"
