...
text+='Default chord example: functional key-to-Pinyin mappings from RIMES chord-keymaps/Isaac2025.json at 20651da. The example can be copied, edited or replaced by an imported JSON profile. No proprietary input-method executable, documentation or artwork is included.\n'
