...
From a repository checkout, Python 3 plus PowerShell 5.1 or 7 can run the repository's reviewed platform-preview policy, stage its exact 55-file dependency closure, and create a self-contained ZIP without network access:
