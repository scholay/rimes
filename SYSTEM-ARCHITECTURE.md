...
本节是当前实现的权威摘要；页首 2026-09-04 最新覆盖优先于本节。后文保留的 Marine Chrome、My Prompt、Remarkable、toolbarless/弹层/专用右侧拖动条、可折叠工具栏、44/78 折叠高度、回传框右侧复制、旧几何、target 角色图标、常驻刷新按钮以及“开启 Buffer 即持续接管所有焦点”的描述是历史实现。
