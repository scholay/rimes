...
## [v0.4.1](https://github.com/scholay/rimes/releases/tag/v0.4.1) — 2026-07-09

### 其他

- v0.4.1: restore schema-switch menu, import user Rime config, tidy input source (8740440)

## [v0.4.0](https://github.com/scholay/rimes/releases/tag/v0.4.0) — 2026-07-09
...
## [v0.3.8](https://github.com/scholay/rimes/releases/tag/v0.3.8) — 2026-07-09

### 其他

- v0.3.8: fix input-source enable/icons on macOS 26 + move menu into system input menu (661a6b2)

## [v0.3.7](https://github.com/scholay/rimes/releases/tag/v0.3.7) — 2026-07-08

### 其他

- Rebrand to 恩特输入法 + new icon set (app, status-bar, input-source) (419db50)

## [v0.3.6](https://github.com/scholay/rimes/releases/tag/v0.3.6) — 2026-07-07

### 其他

- Fix "no candidates": dynamic schema menu + guard stale preference; PDF icon (2719e20)

## [v0.3.5](https://github.com/scholay/rimes/releases/tag/v0.3.5) — 2026-07-07

### 其他

- Add input-mode menu icon (fixes blank input source row + enable failure) (448c74e)

## [v0.3.4](https://github.com/scholay/rimes/releases/tag/v0.3.4) — 2026-07-07

### 其他

- Fix duplicate/blank input source: give the input mode a distinct id (2321f6d)

## [v0.3.3](https://github.com/scholay/rimes/releases/tag/v0.3.3) — 2026-07-07

### 其他

- Show localized name 恩特输入法 in input source list + fix installer dark-mode text (be6c78f)

## [v0.3.2](https://github.com/scholay/rimes/releases/tag/v0.3.2) — 2026-07-07

### 其他

- Add guided .pkg installer for first-time install (568a217)

## [v0.3.1](https://github.com/scholay/rimes/releases/tag/v0.3.1) — 2026-07-07
...
## [v0.3.0](https://github.com/scholay/rimes/releases/tag/v0.3.0) — 2026-07-07
...
## [v0.2.0](https://github.com/scholay/rimes/releases/tag/v0.2.0) — 2026-07-06
...
## [v0.1.0](https://github.com/scholay/rimes/releases/tag/v0.1.0) — 2026-07-06
